/****************************************************************************
** Meta object code from reading C++ file 'Keypa.h'
**
...
#error "The header file 'Keypa.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 28, 13) // "reemitClicked"

    },
    "KeypadButton\0clicked\0\0digit\0reemitClicked"
};
...
void KeypadButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->reemitClicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (KeypadButton::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&KeypadButton::clicked)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void KeypadButton::clicked(int _t1)
{
